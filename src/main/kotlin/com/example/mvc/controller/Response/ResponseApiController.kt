...
class ResponseApiController {
    ...
    fun getMapping(@RequestParam age : Int?): ResponseEntity<String> {
        //@RequestParam  queryParam으로 age라는 값이 없을 경우 400 error발생
        //but 해당 쿼리파람이 필수값이 아닐 경우 자료형 뒤에 "?"를 입력 할 경우 age라는 파라미터가 없어도 정상 실행
        ...
        //위와 같이 ResponseEntity.status값을 줬을 때 특정 쿼리파람에 따라 오류를 발생 시킬 수 있음.
        */
